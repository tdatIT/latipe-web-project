...
<head>
  ...
  <link rel="stylesheet" href="../admin/assets/vendor/css/pages/wizard-ex-checkout.css" />
  <!-- Helpers -->
            ...
            <div class="bs-stepper-header border-0 m-auto">
                ...
                <button type="button" class="step-trigger">
                      <span class="bs-stepper-icon">
                        <svg viewBox="0 0 58 54">
                          <use xlink:href="../admin/assets/svg/icons/wizard-checkout-cart.svg#wizardCart"></use>
                        </svg>
                      </span>
                ...
                <button type="button" class="step-trigger">
                      <span class="bs-stepper-icon">
                        <svg viewBox="0 0 54 54">
                          <use
                                  xlink:href="../admin/assets/svg/icons/wizard-checkout-address.svg#wizardCheckoutAddress"
                          ></use>
                        </svg>
                      </span>
              ...
              <div class="step" data-target="#checkout-payment">
                <button type="button" class="step-trigger">
                      <span class="bs-stepper-icon">
                        <svg viewBox="0 0 58 54">
                          <use xlink:href="../admin/assets/svg/icons/wizard-checkout-payment.svg#wizardPayment"></use>
                        </svg>
                      </span>
              ...
              <div class="step" data-target="#checkout-confirmation">
                <button type="button" class="step-trigger">
                      <span class="bs-stepper-icon">
                        <svg viewBox="0 0 58 54">
                          <use xlink:href="../admin/assets/svg/icons/wizard-checkout-confirmation.svg#wizardConfirm"></use>
                        </svg>
                      </span>
...
<%--                      </div>--%>
                      ...
                      <ul class="list-group mb-3">
                        <li class="list-group-item p-4">
                          <div class="gap-3 d-flex">
                            <div class="flex-shrink-0">
                              <img src="../admin/assets/img/products/1.png" alt="google home" class="w-px-100" />
                            </div>
                        ...
                        <li class="list-group-item p-4">
                          <div class="gap-3 d-flex">
                            <div class="flex-shrink-0">
                              <img src="../admin/assets/img/products/2.png" alt="google home" class="w-px-100" />
                            </div>
                            <div class="flex-grow-1">
                              <div class="row">
                                <div class="col-md-8">
                      ...
                      <div class="border rounded p-3 mb-3">
                        ...
                        <ul class="list-unstyled">
                          <li class="gap-3 d-flex">
                            <div class="flex-shrink-0">
                              <img src="../admin/assets/img/products/1.png" alt="google home" class="w-px-50" />
                            </div>
                            <div class="flex-grow-1">
                              <p class="mb-0">
                          ...
                          <li class="gap-3 d-flex">
                            <div class="flex-shrink-0">
                              <img src="../admin/assets/img/products/2.png" alt="google home" class="w-px-50" />
                            </div>
                            <div class="flex-grow-1">
                              <p class="mb-0">
                        ...
                        <div class="tab-content" id="paymentTabsContent">
                          ...
                          >
                            <div class="row g-3">
                              ...
                              <div class="col-12">
                                <button type="button" class="btn btn-primary btn-next me-1 me-sm-3">Submit</button>
                ...
                <div id="checkout-confirmation" class="content">
                  <div class="row mb-3">
                    <div class="col-12 col-lg-8 offset-lg-2 text-center mb-3">
                      ...
                      <p>
                        <span class="fw-semibold"><i class="bx bx-time-five"></i> Time placed:</span> 25/05/2020
                        13:35pm
                      </p>
                    </div>
                    ...
                    <div class="col-xl-9 mb-3 mb-xl-0">
                      <ul class="list-group">
                        <li class="list-group-item">
                          <div class="gap-3 d-flex">
                            <div class="flex-shrink-0">
                              <img src="../admin/assets/img/products/1.png" alt="google home" class="w-px-75" />
                            </div>
                            <div class="flex-grow-1">
                              <div class="row">
                        ...
                        <li class="list-group-item">
                          <div class="gap-3 d-flex">
                            <div class="flex-shrink-0">
                              <img src="../admin/assets/img/products/2.png" alt="google home" class="w-px-75" />
                            </div>
                            <div class="flex-grow-1">
                              <div class="row">
                                <div class="d-flex col-md-8 flex-column justify-content-center">
...
<script src="../admin/assets/vendor/libs/bs-stepper/bs-stepper.js"></script>
...
<script src="../admin/assets/js/modal-add-new-address.js"></script>
<script src="../admin/assets/js/wizard-ex-checkout.js"></script>
</body>
</html>
