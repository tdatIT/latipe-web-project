...
<head>
    ...
    <title>Latipe Đặt Hàng Thành Công</title>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    ...
                    <h4 class="text-primary">Cảm ơn bạn đã quan tâm.</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__about__logo">
                        <a href="./index.html"><img src="view/web/assets/img/logo.png" alt=""></a>
                    </div>
                    <ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer__copyright">
                    ...
                    <div class="footer__copyright__payment"><img src="view/web/assets/img/payment-item.png" alt=""></div>
                </div>
            </div>
        </div>
    </div>
