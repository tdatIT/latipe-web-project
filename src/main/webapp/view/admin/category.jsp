                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                           href="${pageContext.request.contextPath}/logout">
                                            ...
                                            <span class="align-middle"><a href="
                                                                ${pageContext.request.contextPath}/logout">Log
                                                                Out</a></span>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="card">
                        <div class="card-header border-bottom">
                            ...
                            <div
                                ...
                                <div class="category_status col-md-4">
                            ...
                            <div id="DataTables_Table_0_wrapper"
                                ...
                                <table
                                    ...
                                    <c:forEach var="item" items="${categorys}">
                                        <tr class="odd">
                                            <td class="sorting_1"><a>${item.categoryId}</a>
                                            </td>
                                            <td class="sorting_1">
                                                                <span class="fw-semibold"
                                                                      id="name-${item.categoryId}">${item.name}</span>
                                            </td>
                                            <td>
                                                <img style="width: 200px; height: 200px"
                                                     src="${pageContext.request.contextPath}/upload/${item.image}"
                                                     id="image-${item.categoryId}">
                                            </td>
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="javascript:;"
                                                           ...
                                                           data-bs-target="#offcanvasEditCategory">Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a href="category/delete?categoryId=${item.categoryId}"
                                ...
                                <!-- pagination -->
                                <div id="paginate-category" class="row mx-2 mt-2">
                                    <div class="col-12">
                                                ...
                                                <ul class="pagination">
                                                    ...
                                                    <c:forEach begin="0" end="${endPage}" var="i">
                                                        <li class="page-item paginate_button ${tag==i ? "active" : "" }">
                                                            <a class="page-link"
                                                               href="category?page=${i}">${i+1}</a>
                                                        </li>
                                                    </c:forEach>
                                                    <c:if test="${tag<endPage}">
                                                        <li class="page-item page-item next"><a
                                                                class="page-link"
                                                                href="category?page=${tag+1}">Next</a>
                                                        </li>
                                                    </c:if>
                                                </ul>
                                            </div>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser"
                            ...
                            <div class="offcanvas-body flex-grow-0 mx-0">
                                <form class="add-new-user pt-0" id="addNewCategoryLevelForm" method="post"
                                      role="form" action="category/create" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label"
                                               for="add-image-preview-category">Image</label>
                                        <img id="add-image-preview-category"
                                             style="width: 200px; height: 200px" src="" alt="Avatar"
                                             class="pic-review"/>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Hình Ảnh</label>
                                        <div class="mb-2">
                                            <input name="image" class="form-control pic-add" type="file"
                                                   accept="image/*"/>
                                        </div>
                                    </div>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditCategory"
                            ...
                            <div class="offcanvas-header border-bottom">
                                <h6 id="offcanvasEditCategoryLabel" class="offcanvas-title">
                                    Edit Category
                                </h6>
                                <button type="button" class="btn-close text-reset"
                                        data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            ...
                            <div class="offcanvas-body flex-grow-0 mx-0">
                                <form class="add-new-user pt-0" id="editNewCategoryLevelForm" method="post"
                                      role="form" action="category/edit" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="edit-pic-review">Image</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Hình Ảnh</label>
                                        <div class="mb-2">
                                            <input name="image" class="form-control pic-edit" type="file"
...
<script src="../view/admin/js/category.js"></script>
