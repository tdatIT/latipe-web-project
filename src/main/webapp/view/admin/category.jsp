                                    ...
                                    <c:forEach var="item" items="${categorys}">
                                        <tr class="odd">
                                            <td class="sorting_1"><a
                                                    href="app-invoice-preview.html">${item.categoryId}</a></td>
                                            <td class="sorting_1">
                                                <span class="fw-semibold"
                                                      id="name-${item.categoryId}">${item.name}</span>
                                            </td>
                                            <td>
                                                <img style="width: 200px; height: 200px" src="${pageContext.request.contextPath}/upload/${item.image}" id="image-${item.categoryId}">
                                            </td>
                                            <td style="text-align: center">
                                                <div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <div class="dropdown-divider"></div>
                                                        <a
                                                                href="category/delete?categoryId=${item.categoryId}"
                        ...
                        >
                            ...
                            <div class="offcanvas-body flex-grow-0 mx-0">
                                ...
                                >
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="add-image-preview-category">Image</label>
                                        <img
                                                id="add-image-preview-category"
