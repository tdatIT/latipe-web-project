                                        ...
                                        <div
                                            ...
                                            <div class="order_status col-md-4">
                                                <select id="FilterTransaction" class="form-select text-capitalize">
                                                    ...
                                                    <option value="Inactive" ${option=="3" ? ' selected="selected"' : ''
                                                        }> Success
                                                    </option>
                                                    <option value="Inactive" ${option=="4" ? ' selected="selected"' : ''
                                                        }> Cancel
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="card-datatable table-responsive">
                                        <div id="DataTables_Table_0_wrapper"
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        <th class="control " rowspan="1" colspan="1" style="width: auto"
                                                            aria-label="">
                                                            Order Id
                                                        </th>
                                                ...
                                                <tbody id="action-click">
                                                    <c:forEach var="item" items="${orders}">
                                                        <tr class="odd">
                                                            <td class="sorting_1"><a>${item.orderId}</a></td>
                                                            <td>
                                                                <div
                                                                    class="d-flex justify-content-start align-items-center">
                                                                    <div class="avatar-wrapper">
                                                                        <div class="avatar avatar-sm me-3">
                                                                            <img src="${pageContext.request.contextPath}/upload/${item.storeByStoreId.avatar}"
                                                                                alt="Avatar" class="rounded-circle" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="d-flex flex-column">
                                                                        <a class="text-body text-truncate"><span
                                                                                class="fw-semibold">${item.storeByStoreId.name}</span>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <div class="avatar-wrapper">
                                                                        <div class="avatar avatar-sm me-3">
                                                                            <img src="${pageContext.request.contextPath}/upload/${item.userByUserId.avatar}"
                                                                                alt="Avatar" class="rounded-circle" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="d-flex flex-column">
                                                                        <a class="text-body text-truncate"><span
                                                                                class="fw-semibold">${item.userByUserId.firstname}
                                                                                ${item.userByUserId.lastname}</span>

                                                                            <small
                                                                                class="text-muted">${item.userByUserId.email}</small>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="fw-semibold">${item.deliveryByDeliveryId.name}</span>
                                                            </td>
                                                            <td>
                                                                <span class="fw-semibold">${String.format("%.0f",
                                                                    item.amountFromUser)}</span>
                                                            </td>
                                                            <td>
                                                                <span class="fw-semibold">${String.format("%.0f",
                                                                    item.amountToStore)}</span>
                                                            </td>
                                                            <td>
                                                                <span class="fw-semibold">${String.format("%.0f",
                                                                    item.amountToGd)}</span>
                                                            </td>
                                                            <td>
                                                                ${item.isPaidBefore() != false ?'<span class="badge bg-label-success"> Paid</span>' :
                                                                '<span class="badge bg-label-secondary"> Debt</span>'}
                                                            </td>
                                                            <td>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <c:if test="${item.status == 1}">
                                                                            <a class="dropdown-item text-success"
                                                                                href="order/active?orderId=${item.orderId}&status=2">Delivery</a>
                                                                            <a class="dropdown-item text-success"
                                                                                href="order/active?orderId=${item.orderId}&status=3">Success</a>
                                                                            <a class="dropdown-item text-success"
                                                                                href="order/active?orderId=${item.orderId}&status=4">User
                                                                                Cancel</a>
                                                                            <a class="dropdown-item text-success"
                                                                                href="order/active?orderId=${item.orderId}&status=5">Shop
                                                                                Cancel</a>
                                                                        </c:if>
                                                                        <c:if test="${item.status == 2}">
                                                                            <a class="dropdown-item text-success"
