                                            ...
                                            <table
                                                ...
                                                <tbody id="action-click">
                                                    <c:forEach var="item" items="${products}">
                                                        <tr class="odd">
                                                            <td class="sorting_1"><a>${item.productId}</a>
                                                            </td>
                                                            <td class="sorting_1"><a>${item.name}</a></td>
                                                            <td>
                                                                <img style="width: 50px; height: 50px"
                                                                    src="${pageContext.request.contextPath}/upload/${item.productImgsByProductId[0].fileName}"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex flex-column">
                                                                        <a class="text-body text-truncate"><span
                                                                                class="fw-semibold">${item.storeByStoreId.name}</span></a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="fw-semibold">${item.categoryByCategoryId.name}</span>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <div class="d-inline-block">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <a class="dropdown-item text-success"
                                                                            href="product/active?productId=${item.productId}">Active</a>
                                                                        <div class="dropdown-divider"></div>
