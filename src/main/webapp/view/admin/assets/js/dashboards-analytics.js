...
(function () {
   ...
   const NewUserLineChartEL = document.querySelector('#newuserLineChart'),
      UserLineChartConfig = {
         series: [
            {
               data: [0, 150, 25, 100, 15, 149],
   ...
   if (typeof NewUserLineChartEL !== undefined && NewUserLineChartEL !== null) {
      const referralLineChart = new ApexCharts(NewUserLineChartEL, UserLineChartConfig);
      referralLineChart.render();
   }
