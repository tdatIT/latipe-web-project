<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        <head>
            <meta charset="utf-8" />
            <meta name="viewport"
                content="width=device-width, initial-scale=1.0, store-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
                                ...
                                <div class="card">
                                    <div class="card-header border-bottom">
                                        ...
                                        <div
                                            ...
                                            <div class="storeLevel_status col-md-4">
                                    ...
                                    <div class="card-datatable table-responsive">
                                        <div id="DataTables_Table_0_wrapper"
                                            ...
                                            <!-- table -->
                                            <table
                                                class="datatables-stores table border-top dataTable no-footer dtr-column collapsed"
                                                ...
                                                <tbody id="action-click">
                                                    <c:forEach var="item" items="${storeLevels}">
                                                        <tr class="odd">
                                                            <td class="sorting_1"><a>${item.storeLevelId}</a>
                                                            </td>
                                                            <td class="sorting_1">
                                                                ...
                                                                <div class="d-inline-block">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <a href="javascript:;"
                                                                            ...
                                                                            data-bs-target="#offcanvasEditStoreLevel">Edit</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a href="storeLevel/delete?storeLevelId=${item.storeLevelId}"
                                            ...
                                            <!-- pagination -->
                                            <div id="paginate-storeLevel" class="row mx-2 mt-2">
                                                <div class="col-12">
                                                            ...
                                                            <ul class="pagination">
                                                                ...
                                                                <c:forEach begin="0" end="${endPage}" var="i">
                                                                    <li class="page-item paginate_button ${tag==i ? "active" : "" }">
                                                                        <a class="page-link"
                                                                            href="storeLevel?page=${i}">${i+1}</a>
                                                                    </li>
                                                                </c:forEach>
                                                                <c:if test="${tag<endPage}">
                                                                    <li class="page-item page-item next"><a
                                                                            class="page-link"
                                                                            href="storeLevel?page=${tag+1}">Next</a>
                                                                    </li>
                                                                </c:if>
                                                            </ul>
                                                        </div>
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddStore"
                                        aria-labelledby="offcanvasAddStoreLabel">
                                        <div class="offcanvas-header border-bottom">
                                            <h6 id="offcanvasAddStoreLabel" class="offcanvas-title">Add StoreLevel </h6>
                                            <button type="button" class="btn-close text-reset"
                                                data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                        </div>
                                        <div class="offcanvas-body flex-grow-0 mx-0">
                                            <form class="add-new-store pt-0" id="addNewStoreLevelForm" method="post"
                                                role="form" action="storeLevel/create">
                                                <div class="mb-3">
                                                    <label class="form-label" for="add-storeLevel-name">Name</label>
                                                    <input type="text" class="form-control" id="add-storeLevel-name"
                                                        placeholder="John Doe" name="name" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="storeLevel-point">Min Point</label>
                                                    <input type="number" id="storeLevel-point" class="form-control"
                                                        name="minPoint" />
                                                </div>
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditStoreLevel"
                                        aria-labelledby="offcanvasEditStoreLevelLabel">
                                        <div class="offcanvas-header border-bottom">
                                            <h6 id="offcanvasEditStoreLevelLabel" class="offcanvas-title">
                                                Edit StoreLevel
                                            </h6>
                                            <button type="button" class="btn-close text-reset"
                                                data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                        ...
                                        <div class="offcanvas-body flex-grow-0 mx-0">
                                            <form class="add-new-store pt-0" id="editNewStoreLevelForm" method="post"
                                                role="form" action="storeLevel/edit">
                                                <div class="mb-3">
                                                    <label class="form-label" for="name-storeLevel">Name</label>
                                                    <input type="text" class="form-control" id="name-storeLevel"
                                                        placeholder="John Doe" name="name" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="point-storeLevel">Min Point</label>
                                                    <input type="number" id="point-storeLevel" class="form-control"
                                                        name="minPoint" />
                                                </div>
                                                <button type="submit" class="btn btn-primary data-submit me-1 me-sm-3">
                                                    Submit
            ...
            <%--<script src="../view/admin/assets/vendor/libs/apex-charts/apexcharts.js"></script>--%>
                ...
                <%--<script src="../view/admin/assets/js/dashboards-analytics.js"></script>--%>
                    <%--<script src="../view/admin/assets/js/charts-apex.js"></script>--%>
                        <script src="../view/admin/js/storeLevel.js"></script>
