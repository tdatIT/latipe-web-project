...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        ...
        <%--                <!-- UserLevel -->--%>
        <%--                <li class="menu-item">--%>
        <%--                    <a href="${pageContext.request.contextPath}/admin/userLevel" class="menu-link">--%>
                    ...
                    <div class="card">
                                    ...
                                    <c:forEach var="item" items="${userLevels}">
                                        <tr class="odd">
                                            <td class="sorting_1"><a
                                                    href="app-invoice-preview.html">${item.userLevelId}</a></td>
                                            <td class="sorting_1">
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a
                                                                ...
                                                                data-bs-toggle="offcanvas"
                                                                data-bs-target="#offcanvasEditUserLevel"
                                                        >Edit</a
                                                        >
                                                        <div class="dropdown-divider"></div>
                                                        <a
                                                                href="userLevel/delete?userLevelId=${item.userLevelId}"
                        ...
                        >
                            <div class="offcanvas-header border-bottom">
                                <h6 id="offcanvasAddUserLabel" class="offcanvas-title">Add UserLevel Level</h6>
                                <button
                                        type="button"
                            ...
                            <div class="offcanvas-body flex-grow-0 mx-0">
                                <form
                                        ...
                                        id="addNewUserLevelLevelForm"
                                        method="post"
                                        role="form"
                                        action="userLevel/create"
                                >
                                    <div class="mb-3">
                                        ...
                                        <input
                                                type="text"
                                                class="form-control"
                                                id="add-userLevel-name"
                                                placeholder="John Doe"
                                                name="name"
                                        />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="userLevel-point">Min Point</label>
                                        <input
                                                type="number"
                                                id="userLevel-point"
                                                class="form-control"
                        ...
                        >
                            ...
                            <div class="offcanvas-body flex-grow-0 mx-0">
                                <form
                                        class="add-new-user pt-0"
                                        id="editNewUserLevelForm"
                                        method="post"
                                        role="form"
                                        action="userLevel/edit"
                                >
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="point-userLevel">Min Point</label>
                                        <input
                                                type="number"
                                                id="point-userLevel"
                                                class="form-control"
