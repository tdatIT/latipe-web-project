<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        <body>
                                ...
                                <div class="card">
                                    <div class="card-header border-bottom">
                                        ...
                                        <div
                                            ...
                                            <div class="userLevel_status col-md-4">
                                    ...
                                    <div class="card-datatable table-responsive">
                                        <div id="DataTables_Table_0_wrapper"
                                                    ...
                                                    <div
                                                        ...
                                                        <button class="dt-button add-new btn btn-primary mb-3 mt-3"
                                                            ...
                                                            <span><i class="bx bx-plus me-0 me-lg-2"></i><span
                                                                    class="d-none d-lg-inline-block">Add
                                                                    New
                                                                    UserLevel</span></span>
                                                        </button>
                                                    </div>
                                                        ...
                                                        <tr class="odd">
                                                            ...
                                                            <td class="sorting_1">
                                                                <span class="fw-semibold"
                                                                    id="name-${item.userLevelId}">${item.name}</span>
                                                            </td>
                                                            <td>
                                                                <span class="fw-semibold"
                                                                    id="cost-${item.userLevelId}">${item.minPoint}</span>
                                                            </td>
                                                            <td>
                                                                <span class="fw-semibold"
                                                                    id="des-${item.userLevelId}">${item.discount}</span>
                                                            </td>
                                                                ...
                                                                <div class="d-inline-block">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <a href="javascript:;"
                                                                            ...
                                                                            data-bs-target="#offcanvasEditUserLevel">Edit</a>
                                                                        <div class="dropdown-divider">
                                                                        </div>
                                                                        <a href="userLevel/delete?userLevelId=${item.userLevelId}"
                                            ...
                                            <!-- pagination -->
                                            <div id="paginate-userLevel" class="row mx-2 mt-2">
                                                <div class="col-12">
                                                            ...
                                                            <ul class="pagination">
                                                                ...
                                                                <c:forEach begin="0" end="${endPage}" var="i">
                                                                    <li class="page-item paginate_button ${tag==i ? "active" : "" }">
                                                                        <a class="page-link"
                                                                            href="userLevel?page=${i}">${i+1}</a>
                                                                    </li>
                                                                </c:forEach>
                                                                <c:if test="${tag<endPage}">
                                                                    <li class="page-item page-item next">
                                                                        <a class="page-link"
                                                                            href="userLevel?page=${tag+1}">Next</a>
                                                                    </li>
                                                                </c:if>
                                                            </ul>
                                                        </div>
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser"
                                        ...
                                        <div class="offcanvas-body flex-grow-0 mx-0">
                                            <form class="add-new-user pt-0" id="addNewUserLevelLevelForm" method="post"
                                                role="form" action="userLevel/create">
                                                <div class="mb-3">
                                                    <label class="form-label" for="add-userLevel-name">Name</label>
                                                    <input type="text" class="form-control" id="add-userLevel-name"
                                                        placeholder="John Doe" name="name" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="userLevel-point">Min
                                                        Point</label>
                                                    <input type="number" id="userLevel-point" class="form-control"
                                                        name="minPoint" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="add-userLevel-des">Discount</label>
                                                    <input type="number" id="add-userLevel-des" class="form-control"
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditUserLevel"
                                        aria-labelledby="offcanvasEditUserLevelLabel">
                                        <div class="offcanvas-header border-bottom">
                                            <h6 id="offcanvasEditUserLevelLabel" class="offcanvas-title">
                                                Edit
                                                UserLevel
                                            </h6>
                                            <button type="button" class="btn-close text-reset"
                                        ...
                                        <div class="offcanvas-body flex-grow-0 mx-0">
                                            <form class="add-new-user pt-0" id="editNewUserLevelForm" method="post"
                                                role="form" action="userLevel/edit">
                                                <div class="mb-3">
                                                    <label class="form-label" for="name-userLevel">Name</label>
                                                    <input type="text" class="form-control" id="name-userLevel"
                                                        placeholder="John Doe" name="name" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="point-userLevel">Min
                                                        Point</label>
                                                    <input type="number" id="point-userLevel" class="form-control"
                                                        name="minPoint" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="discount-userLevel">Discount</label>
                                                    <input type="number" class="form-control" id="discount-userLevel"
                                                        placeholder="John Doe" name="discount" step="0.01" />
                                                </div>
                                                <button type="submit" class="btn btn-primary data-submit me-1 me-sm-3">
                                                    Submit
                                                </button>
            ...
            <%--<script src="../view/admin/assets/vendor/libs/apex-charts/apexcharts.js">
                </script>
                --%>
                ...
                <%--<script src="../view/admin/assets/js/dashboards-analytics.js">
                    </script>
                    --%>
                    <%--<script src="../view/admin/assets/js/charts-apex.js">
                        </script>
                        --%>
                        <script src="../view/admin/js/userLevel.js"></script>
