                                    ...
                                    <c:forEach var="item" items="${users}">
                                        <tr class="odd">
                                            <td class="sorting_1"><a
                                                    href="link toi profile :))">${item.userId}</a></td>
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        ><span class="fw-semibold">${item.firstname} ${item.lastname}</span></a
                                            ...
                                            <td>
                                                ...
                                                >${item.userLevelByUserLevelId.name}</span>
                                            </td>
                                            <td>
                                                <span class="fw-semibold"
                                          ...
                                          >${item.roleByRoleId.name}</span
                                          >
                                            </td>
                                            <td>
                                        ${item.getDeleted() != true ?'<span class="badge bg-label-success"> Active</span>' : '<span class="badge bg-label-secondary"> inactive</span>'                                                        }
                                            </td>
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a
                                                                ...
                                                                href="user/active?userId=${item.userId}"
                                                        >Active</a
                                                        >
                                                        <div class="dropdown-divider"></div>
                                                        <a
                                                                href="user/delete?userId=${item.userId}"
