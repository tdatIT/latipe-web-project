                                ...
                                <div class="card">
                                    <div class="card-header border-bottom">
                                        ...
                                        <div
                                            ...
                                            <div class="user_status col-md-4">
                                    ...
                                    <div class="card-datatable table-responsive">
                                        <div id="DataTables_Table_0_wrapper"
                                            ...
                                            <table
                                                ...
                                                <tbody id="action-click">
                                                    <c:forEach var="item" items="${users}">
                                                        <tr class="odd">
                                                            <td class="sorting_1"><a>${item.userId}</a></td>
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <div class="d-flex flex-column">
                                                                        <a class="text-body text-truncate"><span
                                                                                class="fw-semibold">${item.firstname}
                                                                                ${item.lastname}</span></a><small
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="fw-semibold">${item.userLevelByUserLevelId.name}</span>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <span
                                                                    class="text-truncate d-flex align-items-center"><span
                                                                        class="badge badge-center rounded-pill bg-label-primary w-px-30 h-px-30 me-2"><i
                                                                            class="bx bx-pie-chart-alt bx-xs"></i></span>${item.roleByRoleId.name}</span>
                                                            </td>
                                                            <td>
                                                                ${item.getDeleted() != true ?'<span class="badge bg-label-success"> Active</span>' :
                                                                ...
                                                                <div class="d-inline-block">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <a class="dropdown-item text-success"
                                                                            href="user/active?userId=${item.userId}">Active</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a href="user/delete?userId=${item.userId}"
                                            ...
                                            <!-- pagination -->
                                            <div id="paginate-user" class="row mx-2 mt-2">
                                                <div class="col-12">
                                                            ...
                                                            <ul class="pagination">
                                                                <c:if test="${tag>0}">
                                                                    <li class="paginate_button page-item previous"><a
                                                                            class="page-link" href="user?page=${tag-1}"
                                                                ...
                                                                <c:forEach begin="0" end="${endPage}" var="i">
                                                                    <li class="page-item paginate_button ${tag==i ? "active" : "" }">
                                                                        <a class="page-link"
                                                                            href="user?page=${i}">${i+1}</a>
                                                                    </li>
                                                                </c:forEach>
                                                                <c:if test="${tag<endPage}">
                                                                    <li class="page-item page-item next"><a
                                                                            class="page-link"
                                                                            href="user?page=${tag+1}">Next</a>
                                                                    </li>
                                                                </c:if>
                                                            </ul>
                                                        </div>
            ...
            <%--<script src="../view/admin/assets/vendor/libs/apex-charts/apexcharts.js"></script>--%>
                ...
                <%--<script src="../view/admin/assets/js/dashboards-analytics.js"></script>--%>
                    <%--<script src="../view/admin/assets/js/charts-apex.js"></script>--%>
                        <script src="../view/admin/js/user.js"></script>
