...
<head>
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet"
          href="../view/admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css"/>
    ...
    <link rel="stylesheet"
          href="../view/admin/assets/vendor/libs/jquery-timepicker/jquery-timepicker.css"/>
        ...
        <div class="layout-page">
            ...
            <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme"
                ...
                <div class="container-fluid">
                    <div
                            class="layout-menu-toggle navbar-nav d-xl-none align-items-xl-center me-3 me-xl-0">
                                ...
                                <a class="nav-link dropdown-toggle hide-arrow"
                                   ...
                                   data-bs-toggle="dropdown">
                                    <div
                                        ...
                                        <img src=".${pageContext.request.contextPath}/upload/uer.png}"
                                             alt
                    ...
                    <div class="card">
                        <div class="card-header border-bottom">
                            ...
                            <div
                                ...
                                <div
                                        class="delivery_status col-md-4">
                                            ...
                                            <td
                                                    class="sorting_1">
                                                                                                                                <span class="fw-semibold"
                                                                                                                                      id="name-${item.deliveryId}">${item.name}</span>
                                            </td>
                                            <td>
                                                                                                                                <span class="fw-semibold"
                                                                                                                                      id="price-${item.deliveryId}">${item.price}</span>
                                            </td>
                                            <td>
                                                                                                                                <span class="fw-semibold"
                                                                                                                                      id="des-${item.deliveryId}">${item.description}</span>
                                            </td>
                                            <td
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="delivery/delete?deliveryId=${item.deliveryId}"
                        ...
                        <div class="offcanvas offcanvas-end"
                             tabindex="-1" id="offcanvasAddUser"
                             aria-labelledby="offcanvasAddUserLabel">
                            <div
                                    class="offcanvas-header border-bottom">
                                <h6 id="offcanvasAddUserLabel"
                            ...
                            <div
                                    class="offcanvas-body flex-grow-0 mx-0">
                                <form class="add-new-user pt-0"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label"
                                               for="add-delivery-name">Name</label>
                                        <input type="text"
                                               class="form-control"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label"
                                               for="add-delivery-des">Description</label>
                                    ...
                                    <button type="submit"
                                            class="btn btn-primary data-submit me-1 me-sm-3">
                                        Submit
                                    </button>
                                    <button type="reset"
                        ...
                        <div class="offcanvas offcanvas-end"
                             tabindex="-1" id="offcanvasEditDelivery"
                             aria-labelledby="offcanvasEditDeliveryLabel">
                            <div
                                    class="offcanvas-header border-bottom">
                                <h6 id="offcanvasEditDeliveryLabel"
                                    class="offcanvas-title">
                                    Edit
                                    Delivery
                                </h6>
                            ...
                            <div
                                ...
                                <form class="add-new-user pt-0"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label"
                                               for="price-delivery">Price</label>
                                        <input type="number"
                                               id="price-delivery"
                                               class="form-control"
                                               name="cost"/>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label"
                                               for="des-delivery">Description</label>
                                        <input type="text"
                                               class="form-control"
                                               id="des-delivery"
                                               placeholder="John Doe"
...
<script
        src="../view/admin/assets/vendor/libs/bootstrap-datepicker/bootstrap-datepicker.js"></script>
<script
        src="../view/admin/assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js"></script>
<script
        src="../view/admin/assets/vendor/libs/jquery-timepicker/jquery-timepicker.js"></script>
