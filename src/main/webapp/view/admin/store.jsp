                                ...
                                <div class="card">
                                    <div class="card-header border-bottom">
                                        ...
                                        <div
                                            ...
                                            <div class="store_status col-md-4">
                                    ...
                                    <div class="card-datatable table-responsive">
                                        <div id="DataTables_Table_0_wrapper"
                                            ...
                                            <table
                                                ...
                                                <tbody id="action-click">
                                                    <c:forEach var="item" items="${stores}">
                                                        <tr class="odd">
                                                            <td class="sorting_1"><a>${item.storeId}</a></td>
                                                            <td>
                                                                <div
                                                                    class="d-flex justify-content-start align-items-center">
                                                                    <div class="avatar-wrapper">
                                                                        <div class="avatar avatar-sm me-3">
                                                                            <img src="${pageContext.request.contextPath}/upload/${item.avatar}"
                                                                                alt="Avatar" class="rounded-circle" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="d-flex flex-column">
                                                                        <a class="text-body text-truncate"><span
                                                                                class="fw-semibold">${item.name}</span></a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <div class="avatar-wrapper">
                                                                        <div class="avatar avatar-sm me-3">
                                                                            <img src="${pageContext.request.contextPath}/upload/${item.userByOwnId.avatar}"
                                                                                alt="Avatar" class="rounded-circle" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="d-flex flex-column">
                                                                        <a class="text-body text-truncate"><span
                                                                                class="fw-semibold">${item.userByOwnId.firstname}
                                                                                ${item.userByOwnId.lastname}</span></a><small
                                                                            class="text-muted">${item.userByOwnId.email}</small>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <span class="fw-semibold">${item.point}</span>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="text-truncate d-flex align-items-center">${String.format("%.0f",
                                                                    item.eWallet)}</span>
                                                            </td>
                                                            <td>
                                                                ${item.isActive() != false ?'<span class="badge bg-label-success"> Active</span>' :
                                                                ...
                                                                <div class="d-inline-block">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <a class="dropdown-item text-success"
                                                                            href="user/active?storeId=${item.storeId}">Active</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a href="user/delete?storeId=${item.storeId}"
                                                                            class="dropdown-item text-danger delete-record btn-delete">Suspend</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                            ...
                                            <!-- pagination -->
                                            <div id="paginate-store" class="row mx-2 mt-2">
                                                <div class="col-12">
                                                            ...
                                                            <ul class="pagination">
                                                                <c:if test="${tag>0}">
                                                                    <li class="paginate_button page-item previous"><a
                                                                            class="page-link" href="store?page=${tag-1}"
                                                                            tabindex="-1">Previous</a>
                                                                    </li>
                                                                </c:if>
                                                                <c:forEach begin="0" end="${endPage}" var="i">
                                                                    <li class="page-item paginate_button ${tag==i ? "
                                                                        active" : "" }">
                                                                        <a class="page-link"
                                                                            href="store?page=${i}">${i+1}</a>
                                                                    </li>
                                                                </c:forEach>
                                                                <c:if test="${tag<endPage}">
                                                                    <li class="page-item page-item next"><a
                                                                            class="page-link"
                                                                            href="store?page=${tag+1}">Next</a>
                                                                    </li>
                                                                </c:if>
                                                            </ul>
                                                        </div>
            ...
            <%--<script src="../view/admin/assets/vendor/libs/apex-charts/apexcharts.js"></script>--%>
                ...
                <%--<script src="../view/admin/assets/js/dashboards-analytics.js"></script>--%>
                    <%--<script src="../view/admin/assets/js/charts-apex.js"></script>--%>
                        <script src="../view/admin/js/store.js"></script>
