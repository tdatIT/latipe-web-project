                                    ...
                                    <c:forEach var="item" items="${stores}">
                                        <tr class="odd">
                                            <td class="sorting_1"><a
                                                    href="link toi profile :))">${item.storeId}</a></td>
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center">
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar avatar-sm me-3">
                                                            <img
                                                                    src="${pageContext.request.contextPath}/upload/${item.avatar}"
                                                                    alt="Avatar"
                                                                    class="rounded-circle"
                                                            />
                                                        </div>
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        ><span class="fw-semibold">${item.name}</span></a
                                                        >
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center">
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar avatar-sm me-3">
                                                            <img
                                                                    src="${pageContext.request.contextPath}/upload/${item.userByOwnId.avatar}"
                                                                    alt="Avatar"
                                                                    class="rounded-circle"
                                                            />
                                                        </div>
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a
                                                                href="link toi profile :))"
                                                                class="text-body text-truncate"
                                                        ><span class="fw-semibold">${item.userByOwnId.firstname} ${item.userByOwnId.lastname}</span></a
                                                        ><small class="text-muted">${item.userByOwnId.email}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                              ...
                                              >${String.format("%.0f", item.eWallet)}</span
                                              >
                                            </td>
                                            <td>
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a
                                                                ...
                                                                href="user/active?storeId=${item.storeId}"
                                                        >Active</a
                                                        >
                                                        <div class="dropdown-divider"></div>
                                                        <a
                                                                href="user/delete?storeId=${item.storeId}"
