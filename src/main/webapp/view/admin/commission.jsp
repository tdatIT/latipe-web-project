...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        ...
        <%--                <!-- Commission -->--%>
        <%--                <li class="menu-item">--%>
        <%--                    <a href="${pageContext.request.contextPath}/admin/commission" class="menu-link">--%>
                    ...
                    <div class="card">
                                    ...
                                    <c:forEach var="item" items="${commissions}">
                                        <tr class="odd">
                                            <td class="sorting_1"><a
                                                    href="app-invoice-preview.html">${item.commissionId}</a></td>
                                            <td class="sorting_1">
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a
                                                                ...
                                                                data-bs-toggle="offcanvas"
                                                                data-bs-target="#offcanvasEditCommission"
                                                        >Edit</a
                                                        >
                                                        <div class="dropdown-divider"></div>
                                                        <a
                                                                href="commission/delete?commissionId=${item.commissionId}"
                        ...
                        >
                            <div class="offcanvas-header border-bottom">
                                <h6 id="offcanvasAddUserLabel" class="offcanvas-title">Add Commission Level</h6>
                                <button
                                        type="button"
                            ...
                            <div class="offcanvas-body flex-grow-0 mx-0">
                                ...
                                >
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="add-commission-des">Description</label>
                                        <input
                                                type="text-area"
                                                id="add-commission-des"
                                                class="form-control"
                                                name="description"
                                        />
                                    </div>
